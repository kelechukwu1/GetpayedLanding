...
export default function Home() {
  return (
    <main className="backdrop-blur-sm h-screen flex flex-col justify-center items-center relative">
      <Button className="xs:mt-10 px-3 mb-5 rounded-full xs:text-xs text-sm border-t border-stone-500 bg-customGray hover:bg-customGray text-extralight text-gray-300 z-10">
        Waitlist v1 • Coming Soon
      </Button>
      <div className="relative flex flex-col gap-y-5 px-5 w-full md:w-[50rem] lg:w-[65rem] lg:min-w-[40rem] xs:mb-36 mb-52 md:mb-20">
        <Typography
      ...
      <div className="flex justify-center absolute w-full top-[3.3rem] left-1/2 transform -translate-x-1/2">
        <Image
          className="w-full"
          src="/Gradient.png"
          alt="Bright Light"
